...
export const metadata: Metadata = { title: "Blog", description: "Lotus Güzellik bakım ve wellness yazıları" };

export default function BlogPage() {
  return <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
    <header className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[.24em] text-primary">Lotus Blog</p><h1 className="mt-4 text-5xl sm:text-6xl">Bakım dünyasından notlar</h1><p className="mt-5 max-w-2xl text-sm leading-7 text-muted">Kendinize ayırdığınız zamanı güzelleştirecek bakım önerileri, uzman notları ve sakin yaşam ritüelleri.</p></header>
