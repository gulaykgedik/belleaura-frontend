...
const testimonials = [
  ["Zeynep A.", "Lotus’ta her randevu sakin, özenli ve gerçekten bana ayrılmış bir zaman gibi hissettiriyor."],
...
export default function AboutPage() {
  return <>
    <div className="bg-[#f7f2ed] px-4 pb-20 pt-16 sm:px-6 sm:pt-20 lg:px-8 lg:pb-28">
      <header className="mx-auto mb-10 max-w-3xl text-center"><p className="text-xs font-bold uppercase tracking-[.3em] text-primary">Hakkımızda</p><h1 className="mt-4 text-4xl sm:text-5xl">Lotus Güzellik Hakkında</h1><div className="mx-auto mt-5 flex w-24 items-center gap-2 text-primary/60" aria-hidden="true"><span className="h-px flex-1 bg-current"/><span className="font-serif text-xl">✦</span><span className="h-px flex-1 bg-current"/></div></header>
...
function EditorialPair(){return <div className="relative min-h-[520px]"><div className="absolute left-0 top-0 h-[76%] w-[70%] overflow-hidden rounded-[8rem_8rem_2rem_2rem]"><Image src={demoImages.spa} alt="Lotus bakım yaklaşımını yansıtan sıcak spa odası" fill sizes="(max-width: 1024px) 70vw, 35vw" className="object-cover"/></div><div className="absolute bottom-0 right-0 h-[58%] w-[55%] overflow-hidden rounded-[2rem_7rem_7rem_2rem] border-[10px] border-background"><Image src={demoImages.products} alt="Özenle seçilmiş bakım ürünleri" fill sizes="(max-width: 1024px) 55vw, 28vw" className="object-cover"/></div></div>}
