...
const campaignCards: Campaign[] = [
  { title: "İlk Randevuna Özel", category: "Yeni Müşteri", description: "Belle Aura deneyimiyle ilk kez tanışan misafirlerimize özel karşılama fırsatı.", duration: "Ay sonuna kadar", benefit: "%15 avantaj", cta: "Randevu Al", href: "/appointments/new", tone: "bg-[#e7c7b9]" },
